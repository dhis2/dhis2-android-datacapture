...
package org.hisp.dhis.android.datacapture.ui.adapters;
...
public class AutoCompleteDialogAdapter extends BaseAdapter implements Filterable {
    ...
    private static class ViewHolder {
        ...
        public ViewHolder(View view) {
            textView = (TextView) view.findViewById(R.id.option_text_view_item);
        }
    }
    ...
    public static class OptionAdapterValue {
        ...
        public OptionAdapterValue(String id, String label, String data) {
            this.id = id;
            this.label = label;
            this.data = data;
        }
        ...
        public boolean equals(Object o) {
            ...
            return objectsEqual(p.id, id) && objectsEqual(p.label, label)
                    && objectsEqual(p.data, data);
        }
